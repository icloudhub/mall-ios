...
@property(strong, nonatomic) NSString* createTime;// (string, optional): 提交时间 ,
...
@property(strong, nonatomic) NSString* discountAmount ;//(number, optional): 管理员后台调整订单使用的折扣金额 ,
@property(strong, nonatomic) NSString* freightAmount;// (number, optional): 运费金额 ,
