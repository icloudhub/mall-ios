...
@interface ChangeWeChatController () {
    ///输入View
    UIView *inputView;
    ///输入框
    UITextField *infoTF;
...
@implementation ChangeWeChatController

#pragma mark - 视图层
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setWhiteNaviWithTitle:@"修改微信"];
...
- (void)createUI {
    ...
    titleLab.text = @"微信号可以是数字和字母，可包含“_”";
