...
- (void)creatCellUI {
    ...
    oneData.imgStr = @"ic_coupon";
    oneData.titleStr = @"优惠券";
    PersonIconData *twoData = [[PersonIconData alloc] init];
    twoData.imgStr = @"ic_reward_income";
    twoData.titleStr = @"奖励收益";
    dataArr = [[NSMutableArray alloc] initWithObjects:oneData, twoData, nil];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([_walletDelegate respondsToSelector:@selector(walletCellSelectWithTag:)]) {
        [_walletDelegate walletCellSelectWithTag:indexPath.row];
    }
}
